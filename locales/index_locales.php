...
$h1Title = array(
"en"=>" Elegant and beautiful plants",
"fr"=>" Plantes magnifiques et charmantes"
);
$h1UnderTitle= array("en"=>"We are dedicated to bringing life and joy right at your doorstep","fr"=>"Nous nous engageons à apporter la vie et la joie à votre porte!");
$h1Button= array(
"en"=> "View best-sellers" , 
"fr"=>"Voir meilleurs vendeurs"
);
$tropicals= array(
    "en"=>"Tropicals",
    "fr"=>"Tropicales"
...
$tropicalsDef= array(
    "en"=>"View our most unique and distinct plants that can't wait to brighten up the indoors of your safe haven!",
    "fr"=>"Découvrez nos plantes les plus uniques et distinctes pour égayer l'intérieur de votre havre de paix!"
);
$cacti= array(
    "en"=>"Cacti", 
    "fr"=>"Cactus"
...
$cactiDef= array(
    "en"=>"From spiky to fluffy, view our wide range of cacti, one of these certainly won't be enough! Don't worry, they are really friendly!", 
    "fr"=>"Du pointu au plus doux, regardez notre large gamme de cactus, l'un d'entre eux ne suffira certainement pas!"
);
$outdoors= array(
    "en"=>"Garden", 
    "fr"=>"Jardin"
...
$contactDef= array(
    "en"=>"We are always available to provide you with more support!", 
    "fr"=>"Nous sommes toujours disponibles pour vous fournir plus de soutien!"
);
$location= array(
    "en"=>"Location:", 
    "fr"=>"Emplacement:"
